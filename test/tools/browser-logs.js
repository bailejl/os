 ...
 *
 * Original location:
 * https://github.com/contino/cucumber-declarative-gherkin/tree/main/first-bank-of-change/tools/testing
 */
  ...
  return {
    ...
    verify: function verify() {
      ...
      if (cap.browserName === "chrome") {
        ...
        zip(expects, removeMatching(messages, ignores)).forEach(function (
          _ref
        ) {
